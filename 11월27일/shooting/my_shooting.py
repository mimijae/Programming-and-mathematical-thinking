...
class Game():
            ...
            # 게임 화면 이벤트 처리
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_LEFT:
                        ...
                        self.missiles.add(missile2)
                        self.missiles.add(missile3)
    ...
    def run_logic(self, screen):
        # 운석 수와 속도 조절
        occur_of_rocks = 4 + int(self.shot_count / 300)
        min_rock_speed = 4 + int(self.shot_count / 200)
        max_rock_speed = 4 + int(self.shot_count / 100)
    ...
    def display_menu(self, screen):
        ...
        self.draw_text(screen, 'Save the Earth!',
        self.font_60, draw_x, draw_y, YELLOW)
    ...
    def display_frame(self, screen):
        ...
        self.draw_text(screen, 'Destroyed: {}'.format(self.shot_count),
        self.default_font, 100, 20, YELLOW)
        self.draw_text(screen, 'Missed: {}'.format(self.count_missed),
