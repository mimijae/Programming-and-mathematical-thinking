...
assets_path = os.path.join(current_path, 'image_gl')

# 이미지 로딩
img_galaxy = pygame.image.load(os.path.join(assets_path, "galaxy.png"))
img_sship = [
...
img_weapon = pygame.image.load(os.path.join(assets_path, "bullet.png"))
img_shield = pygame.image.load(os.path.join(assets_path, "shield.png"))
img_enemy = [
...
img_title = [
    pygame.image.load(os.path.join(assets_path, "nebula.png")),
    pygame.image.load(os.path.join(assets_path, "logo.png"))
]

# SE 로딩 변수
se_barrage, se_damage, se_explosion, se_shot = None, None, None, None

idx, tmr, score, hisco, new_record, bg_y = 0, 0, 0, 10000, False, 0

ss_x, ss_y, ss_d, ss_shield, ss_muteki, key_spc, key_z = 0, 0, 0, 0, 0, 0, 0

MISSILE_MAX = 200
msl_no = 0 
msl_f = [False] * MISSILE_MAX
msl_x, msl_y, msl_a = [0] * MISSILE_MAX, [0] * MISSILE_MAX, [0] * MISSILE_MAX

ENEMY_MAX = 100
emy_no = 0
emy_f = [False] * ENEMY_MAX
emy_x, emy_y, emy_a = [0] * ENEMY_MAX, [0] * ENEMY_MAX, [0] * ENEMY_MAX
emy_type, emy_speed = [0] * ENEMY_MAX, [0] * ENEMY_MAX 
emy_shield, emy_count = [0] * ENEMY_MAX, [0] * ENEMY_MAX

EMY_BULLET, EMY_ZAKO, EMY_BOSS, = 0, 1, 5
LINE_T, LINE_B, LINE_L, LINE_R = -80, 800, -80, 1040

EFFECT_MAX = 100
eff_no = 0
eff_p, eff_x, eff_y = [0] * EFFECT_MAX, [0] * EFFECT_MAX, [0] * EFFECT_MAX
