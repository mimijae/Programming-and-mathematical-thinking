...
class Game():
    def __init__(self):
        ...
        self.fighters = []
        self.initial_positions = [SCREEN_WIDTH // 2 - 35, SCREEN_WIDTH // 2, SCREEN_WIDTH // 2 + 35] 
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_LEFT:  # 전체 전투기 좌측 이동
                        ...
                        for fighter in self.fighters:
                            ...
                            missile2 = Missile(fighter.rect.centerx, fighter.rect.y, 10)
                            missile3 = Missile(fighter.rect.centerx + 10, fighter.rect.y, 10)
                            self.missiles.add(missile1, missile2, missile3)
