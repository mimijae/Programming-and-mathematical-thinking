...
class Car():
    def __init__(self, x=0, y=0, dx=0, dy=0):
        ...
        car_images_path = os.path.join(assets_path, ('car'))
        ...
        crash_image_path = os.path.join(assets_path, ('crash.png'))
        crash_sound_path = os.path.join(assets_path, ('crash.wav'))
    ...
    def check_crash(self, car):
        if (
            # 현재 자동차의 오른쪽 경계가 다른 자동차의 왼쪽 경계를 넘었는지 확인합니다
            self.x + self.width > car.x

            and # 현재 자동차의 왼쪽 경계가 다른 자동차의 오른쪽 경계보다 왼쪽에 위치하는지 확인합니다
            self.x < car.x + car.width

            and # 현재 자동차의 위쪽 경계가 다른 자동차의 아래쪽 경계보다 위쪽에 위치하는지 확인합니다
            self.y < car.y + car.height

            and # 현재 자동차의 아래쪽 경계가 다른 자동차의 위쪽 경계를 넘었는지 확인합니다
...
class Game():
    def __init__(self):
        # 게임 리소스 로드
        menu_image_path = os.path.join(assets_path, ('menu_car.png'))
    ...
    def display_menu(self, screen):
        ...
        self.draw_text(screen, "Fast & Furious", self.font_40, draw_x, draw_y + 50, BLACK)
